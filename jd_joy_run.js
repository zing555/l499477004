...
//此处填入你需要助力好友的京东用户名
//下面给出好友邀请助力的示例填写规则
let invite_pins = ["499477004_m"];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ["499477004_m"];
let temp = run_pins[0].split(',')
let fixPins = temp.splice(temp.indexOf('499477004_m'), 1);
fixPins.push(...temp.splice(temp.indexOf('499477004_m'), 1));
